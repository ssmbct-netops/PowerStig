...
* Fixed [#570](https://github.com/microsoft/PowerStig/issues/570): Example using ManualCheckFile with multiple Vulnerability objects. Updated the ManualCheckFile to now use XML file and provided template at \StigData\Templates.
